class Caverntower1 extends Phaser.Scene {
    constructor() {
        super({ key: 'Caverntower1' });
    }

    preload() {
        // Preload assets
        this.load.image('background_ct5', 'graphics/caverntower.png');
    ...
    create() {
        ...
        // Set the background
        const background = this.add.image(750, 450, 'background_ct5');
        ...
        checkIntroMessage(this, "Caverntower1", "This tower seems eerily familiar.", this);
    ...
    update() {
        ...
        // Log the sprite's X and Y coordinates
        console.log(`Sprite X: ${this.sprite.x}, Sprite Y: ${this.sprite.y}`);
