class Cavernhall2 extends Phaser.Scene {
    constructor() {
        super({ key: 'Cavernhall2' });
    }

    preload() {
        // Preload assets
        this.load.image('background_ch2', 'graphics/cavern.png');
    ...
    create() {
        console.log('Creating Cavernhall2 scene');
    
        // Set the background
        const background = this.add.image(750, 450, 'background_ch2');
        ...
        checkIntroMessage(this, "Cavernhall2", "This barren hall stretches east-west through the Goblin Castle.", this);
