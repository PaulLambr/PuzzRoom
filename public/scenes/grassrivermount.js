class Grassrivermount extends Phaser.Scene {
    constructor() {
        super({ key: 'Grassrivermount' });
    }

    preload() {
        // Preload assets
        this.load.image('background_grm', 'graphics/gplusmplusr.png');
    ...
    create() {
        console.log('Creating GRM scene');
        ...
        // Set the background
        const background = this.add.image(750, 450, 'background_grm');
        ...
        checkIntroMessage(this, "Grassrivermount", "The bosom of the mountain heaves forth the headwaters of the swift Kenmoria River.", this);
        ...
        // Set current scene
        localStorage.setItem('currentScene', 'Grassrivermount');
    ...
    update() {
        ...
        if (this.sprite.y < 100 && !this.hasTransitioned) {
