class Grassriver1 extends Phaser.Scene {
    constructor() {
        super({ key: 'Grassriver1' });
    }
    ...
    create() {
        console.log('Creating GR1 scene');
        ...
        // Set the background
        const background = this.add.image(750, 450, 'background_gr1');
        ...
        checkIntroMessage(this, "Grassriver1", "The prairie stretches eastward with the skirts of a swamp beginning in the southeast corner.", this);
